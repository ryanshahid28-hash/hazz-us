      ...
      */}
      <div className="relative max-w-5xl mx-auto px-6 mb-24 z-20">
        <div className="relative overflow-hidden bg-zinc-900 border border-zinc-800 rounded-3xl p-10 md:p-16 text-center shadow-2xl flex flex-col items-center group">
          ...
          <Link 
            href="#contact" 
            className="relative z-10 inline-block bg-cyan-400 hover:bg-cyan-300 text-zinc-950 text-xl font-black px-12 py-5 rounded-full transition-all shadow-[0_0_30px_rgba(34,211,238,0.5)] hover:shadow-[0_0_50px_rgba(34,211,238,0.8)] hover:scale-105"
          >
            Let's Talk
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-4 flex flex-col">
            ...
            <ul className="flex flex-col gap-3 mb-6">
              <li>
                <a href="mailto:hello@hazz-us.com" className="text-zinc-400 hover:text-cyan-400 text-sm font-medium transition-colors flex items-center gap-3">
